        ...
        <div class="row justify-content-center mt-5" style="padding: 0px;">
            ...
            <div class="col-lg-5  shadow-sm col_others_post">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-2">
                            <img src="<?php echo $post["image"];?>" class="mt-1 username_post" alt="" height="40px" width="40px" style="border-radius:50%;">
                        </div>
                ...
                <div class="footer">
                    <div class="row mt-3 mb-3" style="text-center">
                        ...
                        <div class="col text-center">
                            <p>
                                <a class="btn text-light" data-bs-toggle="collapse" href="#collapseExample<?php echo $post["id"];?>" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        ...
                                        <?php if($comment["post_id"] == $post["id"]):?>
                                            <div class="list-group mt-1" >
                                                <a href="#" class="list-group-item list-group-item-action active" aria-current="true" style="background:#212529;border: none;border-radius: 10px;">
                                                    ...
                                                    <img src="<?php echo $comment["image"]; ?>" class="mt-1 " alt="" height="40px" width="40px" style="border-radius:50%;">
